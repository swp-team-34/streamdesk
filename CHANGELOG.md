...
- Changed Calendar Day, 3 Days, and Week views to a continuously scrollable, day-snapping timeline with adjacent-date buffering, synchronized toolbar navigation, keyboard, mouse, trackpad, and touch controls, plus direct Month-to-Day navigation from date cells.
