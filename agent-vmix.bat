...
if not defined STREAMDESK_AGENT_LOCATION set "STREAMDESK_AGENT_LOCATION=vMix workstation"
if not defined STREAMDESK_VMIX_URL set "STREAMDESK_VMIX_URL=http://127.0.0.1:8088/api"
if not defined STREAMDESK_AGENT_INTERVAL_SEC set "STREAMDESK_AGENT_INTERVAL_SEC=15"
set "STREAMDESK_AGENT_TYPE=vmix"
